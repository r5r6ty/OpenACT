...
namespace XLua.CSObjectWrap
{
    ...
    public class ffffffWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ffffff);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "asd", _g_get_asd);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "asd", _s_set_asd);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ffffff constructor!");
        ...
        static int _m_Intersects(RealStatePtr L)
        {
		    try {
                ...
                ffffff gen_to_be_invoked = (ffffff)translator.FastGetCSObj(L, 1);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _offsetr;translator.Get(L, 4, out _offsetr);
                        ...
                        bool gen_ret = ffffff.MyIntersects2( _lhs, _offsetl, _rhs, _offsetr );
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _offsetr;translator.Get(L, 4, out _offsetr);
                        ...
                        bool gen_ret = ffffff.MyIntersects( _lhs, _offsetl, _rhs, _offsetr );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_asd(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                ffffff gen_to_be_invoked = (ffffff)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.asd);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_asd(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                ffffff gen_to_be_invoked = (ffffff)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.asd = (UnityEngine.BoxCollider2D[])translator.GetObject(L, 2, typeof(UnityEngine.BoxCollider2D[]));
